...
from ..utils.nn import checkpoint, conv_nd, linear, avg_pool_nd, zero_module, normalization, timestep_embedding
...
class Upsample(nn.Module):
    ...
    :param resample_2d: boolean flag that, if activated, execute the resampling only
                        along the H and W dimensions.
    """
